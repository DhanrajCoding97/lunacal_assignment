  ...
  return (
    <div className="px-3 py-[18px] bg-[#363C43] rounded-[18.89px] flex gap-5 w-full">
        ...
        <Tabs defaultValue="about" className="flex-1">
            ...
            <TabsContent value="about" className="max-h-[175px] overflow-auto gradient-scrollbar pr-1 font-family-jakarta">
            ...
            <TabsContent value="experiences" className="max-h-[175px] overflow-auto gradient-scrollbar font-family-jakarta">
            ...
            <TabsContent value="recommended" className="max-h-[175px] overflow-auto gradient-scrollbar font-family-jakarta">
